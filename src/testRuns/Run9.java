...
public class Run9 
	...
	public static void main(String[] args) throws Exception 
		...
		String ReportText = "1) Run9 Chrome Launched";										// Set up report text variable
		...
		if (whatiscurrenturl.contains(testurl1))											// Test if Home page exists
			...
			String SS = "LoginPass9_";														// Create variable to help name the Screenshot
			...
			if (whatiscurrenturl.contains(testurl2))										// Test if logon page exists
				...
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\User\Documents\Automation results 
				String SS = "LoginFail9_";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				...
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\User\Documents\Automation results 
				String SS = "LoginError9_";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																// Drop out of script
				}
			}
		...
		driver.findElement(By.xpath("//input[@id='textfilteraccount-table']")).sendKeys("Hopewiser Test"); // Enter User name
		...
		//html/body/div/div/div/section[2]/article/div/div[2]        <a href="/hostedmgr/acct/319/user/create" class="ym-button ym-small">Create&nbsp;New</a>
		driver.findElement(By.xpath("//a[contains(.,'Create New')]")).click();				// Click on create a new button
				
		// This is to open the Excel file. Excel path, file name and the sheet name are parameters to this method				
		ExcelUtils.setExcelFile(Constant.Path_TestData1 + Constant.File_TestData1,"Sheet14");// Look in the Excel sheet for test data
		...
		if (whatiscurrenturlC.contains(testurlC1))											// Test if Home page exists
			...
			Output.FilePlusConsole(ReportText); 											// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\User\Documents\Automation results 
			String SS = "CreatePass9";														// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);											// Create Screenshot using appModule.ScreenShot_Action
			}
		else
			{	
			if (whatiscurrenturlC.contains(testurlC2))										// Test if logon page exists
				...
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\User\Documents\Automation results
				String SS = "CreateFail9";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																// Drop out of script
				}
			else
				...
				String SS = "CreateError9";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																// Drop out of script
				}
			}
        ...
        // Edit the user				
		driver.findElement(By.xpath("//a[contains(.,'Qatest-cca-ha')]")).click();  			// Click the user
		Timeloop.Execute(driver, "/user");													// Ensure the correct page is displayed in a sensible time				
        ...
        // This is to open the Excel file. Excel path, file name and the sheet name are parameters to this method				
		ExcelUtils.setExcelFile(Constant.Path_TestData1 + Constant.File_TestData1,"Sheet15"); // Look in the Excel sheet for test data
		...
		if (whatiscurrenturlE.contains(testurlE1))											// Test if Account page exists
			...
			Output.FilePlusConsole(ReportText); 											// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\User\Documents\Automation results
			String SS = "EditPass9";														// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);											// Create Screenshot using appModule.ScreenShot_Action
			}
		else
			{	
			if (whatiscurrenturlE.contains(testurlE2))										// Test if home page exists
				...
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\User\Documents\Automation results
				String SS = "EditFail9";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																// Drop out of script
				}
			else
				...
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\User\Documents\Automation results
				String SS = "EditError9";													// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);										// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																// Drop out of script
				}
			}
        ...
        // Delete the User				
		driver.findElement(By.xpath("//input[@id='textfilteruser-table']")).sendKeys("Qatest-cca-ha"); // Enter the provided user name
		Thread.sleep(3000);																   	// Pause 3 seconds for page update
				
		driver.findElement(By.xpath("//span[contains(.,'Qatest-cca-ha')]")).click(); 		// Select the user from the table
		...
		if (whatiscurrenturlD.contains(testurlD1))											// Test if Account page exists
			...
			Output.FilePlusConsole(ReportText); 											// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\User\Documents\Automation results
			String SS = "DeletePass9_";														// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);											// Create Screenshot using appModule.ScreenShot_Action
			try 
				{	
				driver.findElement(By.xpath("//span[contains(.,'Qatest-cca-ha')]")).click();// Cost Centre Test should not exist so exception should be raised
				}
			catch (Exception e)
				{
				ReportText = "8) Qatest-cca-ha is deleted";									// Set up report text variable
				Output.FilePlusConsole(ReportText); 										// Print validation text to File and Console
				}
			ReportText = "9) if 8 is missing Qatest-cca-ha has not been deleted";			// Set up report text variable
			Output.FilePlusConsole(ReportText); 											// Print validation text to File and Console
			}
		else
			{	
			...
			Output.FilePlusConsole(ReportText); 											// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\User\Documents\Automation results
			String SS = "DeleteError9_";													// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);											// Create Screenshot using appModule.ScreenShot_Action
			System.exit(1);																	// Drop out of script
			}
