...
public class Run32 
    ...
    public static void main(String[] args) throws Exception 
		...
		String ReportText = "1) Run32 Chrome Launched";												// Set up report text variable
		...
		driver.findElement(By.xpath("//span[contains(.,'HopewiserQAAutomation')]")).click();		// Click the HopewiserQAAutomation Account in the table
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "CCUserpage32_";																		// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "UserDetailsPage32_";																	// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
    	...
    	driver.findElement(By.xpath("//a[@href='/hostedmgr/bund']")).click();						// Click the Bundles link
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "BundlePage32_";																		// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
    	...
    	try
    		{
    		driver.findElement(By.xpath("//td[1]/a/span/span")).click();							// Click on Bundle number link	
    		}
    	catch (Exception e)
    		{
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "BundleUsagepage32_";																	// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		float Percent = ((Click_Remaining_Num1 * 90) / 100);										// Calculate how many clicks are needed to change text colour
		HowManyClicks = ((int)Math.ceil(Percent));													// Ensure this variable is a full number and rounded up
    	ReportText = "18) Clicks Remaining: " + Clicks_Remaining + " 90 Percent = " + HowManyClicks;// Set up report text variable
		Output.FilePlusConsole(ReportText);															// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "StartingClicks32_";																	// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		if (Click_Usage_Num1<Click_Usage_Num2)														// Test if Home page exists
			...
			Output.FilePlusConsole(ReportText); 													// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
			SS = "ClicksReducedPass32_";															// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);													// Create Screenshot using appModule.ScreenShot_Action
			}
		else
			{	
			...
			Output.FilePlusConsole(ReportText); 													// Print validation text to File and Console
			// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
			SS = "ClicksReducedFail32_";															// Create variable to help name the Screenshot
			ScreenShot_Action.Execute(driver, SS);													// Create Screenshot using appModule.ScreenShot_Action
			System.exit(1);																			// Drop out of script
			}
		...
		SS = "UsageColourChange32_";																// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		// Find High Warning color (Need more skills to drag the color out of the style due to the ; in it.
    	/*try
    		{
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results 	
		SS = "ClicksRemaining32_";																	// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		driver.findElement(By.partialLinkText(replaced2)).click();									// Click the bundle number link
		...
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results 	
		SS = "Expired32_";																			// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		
    	// Checking that warning emails have been sent needs to be done manually at the moment
    	ReportText = "30) Check if 10% 'AddressServer in the Cloud Plan Expires Soon' email exists";// Set up report text variable
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
