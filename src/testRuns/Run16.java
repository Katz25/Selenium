...
public class Run16 
    ...
    public static void main(String[] args) throws Exception 
		...
		String ReportText = "1) Run16 Chrome Launched";												// Set up report text variable
		...
		if (whatiscurrenturl.equals(testurl1))														// Test if Home page exists
			...
			String SS = "LoginPass16_";																// Create variable to help name the Screenshot
			...
			if (whatiscurrenturl.contains(testurl2))												// Test if logon page exists
				...
				Output.FilePlusConsole(ReportText); 												// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
				String SS = "LoginFail16_";															// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);												// Create Screenshot using appModule.ScreenShot_Action
				...
				Output.FilePlusConsole(ReportText); 												// Print validation text to File and Console
				// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
				String SS = "LoginError16_";														// Create variable to help name the Screenshot
				ScreenShot_Action.Execute(driver, SS);												// Create Screenshot using appModule.ScreenShot_Action
				System.exit(1);																		// Drop out of script
				}
			}
		...
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		String SS = "CCUsageAccordion16_";															// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		Mimic.findElement(By.xpath("//input[@id='username']")).sendKeys(user); 						// Enter the User Name
    	...
    	new Select(Mimic.findElement(By.id("dataset"))).selectByVisibleText("uk-rm-paf-internal"); 	// Select PAF dataset from the drop down
    	Thread.sleep(3000);																			// Pause 3 seconds for page update
		...
		Output.FilePlusConsole(ReportText); 														// Print validation text to File and Console
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "Select16_";																			// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
		...
		Thread.sleep(3000);																			// Pause 3 seconds for page update
		// Create Screenshot png file in C:\Users\Maxine\Documents\Automation results
		SS = "CCUsageAccordion16_";																	// Create variable to help name the Screenshot
		ScreenShot_Action.Execute(driver, SS);														// Create Screenshot using appModule.ScreenShot_Action
