 ...
 * Selenium tests V1
 */
public class EditYourDetails_Action 
	{
	public static void Execute(WebDriver driver) throws Exception
		...
		//String sEmailUser = ExcelUtils.getCellData(1, 3);
		//String sCostCentre = ExcelUtils.getCellData(1, 4);		
		//String sAdminLevel = ExcelUtils.getCellData(1, 5);		
		String sDefaultAddressReference = ExcelUtils.getCellData(1, 6);
		//String sDailyClicks = ExcelUtils.getCellData(1, 7);
