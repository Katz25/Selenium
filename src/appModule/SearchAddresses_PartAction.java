 ...
 * Selenium tests V1
 */
public class SearchAddresses_PartAction 
	{	
	public static void main(WebDriver driver, int HowManyClicks , String Dataset) throws Exception
		{		
		//int HowManyClicks = 99;
		//Dataset = "uk-rm-paf-internal";															// Set dataset
		//Dataset = "uk-rm-paf-external";															// Set dataset
		...
		String sName = "QAAutomation";																// Set user name
		...
		//sdataset.selectByVisibleText("uk-rm-paf-internal");										// Select dataset
		//sdataset.selectByVisibleText("uk-rm-paf-external");										// Select dataset
	    Thread.sleep(3000);																			// Pause 3 seconds for page update
